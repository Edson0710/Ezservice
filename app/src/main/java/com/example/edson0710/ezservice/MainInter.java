...
public class MainInter extends AppCompatActivity {
     ...
     */
    private MainInter.SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter = new MainInter.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    Solicitar_Inter soli = new Solicitar_Inter();
        ...
        JsonObjectRequest peticion = new JsonObjectRequest
                (
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MainInter.this, "Error php", Toast.LENGTH_SHORT).show();
                    }
                });
        RequestQueue x = Volley.newRequestQueue(MainInter.this);
        x.add(peticion);
    }
